...
public class MenuFrame extends JFrame 
{
   ...
   public MenuFrame()
   {
      ...
      fileMenu.setMnemonic('F'); // set mnemonic to F// setMnemonic é a definicao do atalho 
      ...
      setJMenuBar(bar); // add menu bar to application // bar é barra onde fica as opçoes do menu no caso file e o format
      ...
      for (int count = 0; count < colors.length; count++)  // for é uma estrutura de repeticao  
      {
         colorItems[count] = 
